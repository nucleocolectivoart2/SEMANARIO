                        ...
                        <div className="space-y-12">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                              {[
                                "Centro Cultural La Huerta", "Restaurante Bar Agua Dulce",
                                "Teatro Casa Clown", "Teatro Matacandelas",
                                "Corporación Cultural Viva Palabra", "Pequeño Teatro",
                                "El club del Jazz", "La Casa Centro Cultural"
                              ].map((org, i) => (
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                              {[
                                "Teatro Popular de Medellín", "Palacio de Bellas Artes",
                                ...
                                <div key={i} className="bg-white p-4 border border-gray-100 hover:border-brand-gold hover:bg-gray-50/30 transition-all group shadow-sm cursor-default">
                                  <div className="flex items-center gap-3">
                                    <div className="w-1.5 h-1.5 bg-brand-gold rounded-full transition-colors group-hover:scale-125" />
                                    <span className="font-bold text-xs md:text-sm uppercase tracking-tight group-hover:text-brand-gold transition-colors">{org}</span>
                                  </div>
                                </div>
                              ))}
                            </div>
